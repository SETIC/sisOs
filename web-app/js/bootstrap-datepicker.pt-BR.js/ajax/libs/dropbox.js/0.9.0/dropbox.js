...
(function() {
  ...
  Dropbox.Client = (function() {
    ...
    Client.prototype.authorizeUrl = function(token) {
      ...
      params = {
        oauth_token: token,
        oauth_callback: this.driver.url(token)
      };
  ...
  */
  ...
  Dropbox.Xhr = (function() {
    ...
    Xhr.prototype.onReadyStateChange = function() {
      var allHeaders, apiError, bytes, dirtyText, headers, i, metadata, metadataJson, text, _i, _ref;
    ...
    Xhr.prototype.onXdrLoad = function() {
      ...
      switch (this.xhr.contentType) {
        case 'application/x-www-form-urlencoded':
          this.callback(null, Dropbox.Xhr.urlDecode(text), void 0, headers);
          break;
        case 'application/json':
        case 'text/javascript':
          this.callback(null, JSON.parse(text), void 0, headers);
          break;
        default:
          this.callback(null, text, void 0, headers);
      }
      return true;
    };
