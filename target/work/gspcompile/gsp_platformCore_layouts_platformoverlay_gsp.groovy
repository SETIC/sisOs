...
public String getGroovyPageFileName() { "/WEB-INF/plugins/platform-core-1.0.0/grails-app/views/layouts/platform/overlay.gsp" }
public Object run() {
Writer out = getOut()
...
public static final long LAST_MODIFIED = 1457455115201L
