...
class gsp_projetoOS_ordemDeServicoeditarOrdemDeServico_gsp extends GroovyPage {
...
printHtmlPart(6)
for( _it1974869463 in (ordemDeServico) ) {
changeItVariable(_it1974869463)
printHtmlPart(6)
}
printHtmlPart(8)
createTagBody(2, {->
...
printHtmlPart(17)
for( _it123816609 in (status) ) {
changeItVariable(_it123816609)
printHtmlPart(18)
...
invokeTag('form','g',138,['controller':("ordemDeServico"),'action':("atualizar"),'class':("form-horizontal")],2)
printHtmlPart(25)
})
...
public static final long LAST_MODIFIED = 1457008432617L
