...
class gsp_projetoOS_ordemDeServicolistarOrdemDeServico_gsp extends GroovyPage {
...
invokeTag('link','g',21,['controller':("Layout"),'action':("index")],2)
printHtmlPart(5)
...
printHtmlPart(13)
for( _it290159538 in (ordemDeServico) ) {
changeItVariable(_it290159538)
printHtmlPart(14)
...
printHtmlPart(19)
invokeTag('formatDate','g',95,['format':("dd/MM/yyyy"),'type':("datetime"),'style':("MEDIUM"),'date':(it.dataEmissao)],-1)
printHtmlPart(20)
...
public static final long LAST_MODIFIED = 1457008413217L
